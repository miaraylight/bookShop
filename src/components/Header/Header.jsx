    ...
    <div className={s.wrapper}>
        <div className={s.head}>
            ...
            <div className={s['social-media']}>
              <a className={s['social-media-link']} href="https://www.facebook.com/" target="_blank"><img src="../../../public/image/fb-icon.svg" alt="fb-icon" /></a>
              <a className={s['social-media-link']} href="https://twitter.com/" target="_blank"><img src="../../../public/image/twitter-icon.svg" alt="twitter-icon" /></a>
              <a className={s['social-media-link']} href="https://www.linkedin.com/" target="_blank"><img src="../../../public/image/linkedin-icon.svg" alt="linkedin-icon" /></a>
            </div>
        </div>
